...
{
    public partial class FacturaFormDBA : Form
    {
        ...
        public FacturaFormDBA(MySqlConnection connection)
        {
            InitializeComponent();
        ...
        private void OpenFacturaFormDBAv2()
        {
            FacturaFormDBAv2 facturaFormDBAv2 = new FacturaFormDBAv2(connection);
            facturaFormDBAv2.ShowDialog();
        }
    }
